...
sans vous soucier du système.

Dans le prochain post, vous apprendrez à créer votre propre clappybot à partir de 0 mais si vous voulez juste l'ajouter à votre projet existant, lisez plutôt : [⏬️ Inclure dans un projet existant](/clappybot/include).