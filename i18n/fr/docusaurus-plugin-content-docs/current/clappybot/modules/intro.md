...
Si vous n'avez pas encore cloné le [Module Template](https://github.com/LeWeeky/Module-template-for-clappybot), vous devriez le faire, il contient a gros lot d'exemples de fonctionnalités qui vous permettrons de créer plus facilement les votres.

Vous pouvez cloner le module grâce à la commande suivante :
