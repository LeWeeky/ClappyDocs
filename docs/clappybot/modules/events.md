...
a welcome message when someone joins a guild, react when someone writes a message, clicks on a boton or whatever.

When you create a module, you can easly handle this events with a simple folder. In fact, if you create a ` buttons `
